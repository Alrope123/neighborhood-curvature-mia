...
if __name__ == '__main__':
    ...
    for key in args.keys:
        ...
        print(member_key)
        print(member_meta_key)
        print(len(result[member_key]))
        print(len(result[member_meta_key]))
        print(len(result[nonmember_key]))
        print(len(result[nonmember_meta_key]))
